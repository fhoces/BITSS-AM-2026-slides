...
.small[Fernando Hoces de la Guardia, Edward Miguel, Akash Shaji,<br/>
Viviane H. Silva da Rocha, Gufran Pathan, Erik Ø. Sørensen, Bertil Tungodden]
...
<div style="margin-top: -15px; visibility: hidden;">.hi-num[Our stronger intervention helps explain between a quarter to a third of the File Drawer (28%).]</div>
...
<a href="#reg-descriptives-encoders" class="badge-link" style="bottom: 30px;">Registration Descriptives Across Encoders</a>
...
<a href="#estimation" class="badge-link">Estimation &<br/>Hypotheses</a>
...
- Across three outcomes we cannot reject the hypothesis of no incremental effect of Resources → specification that pools Engagement and Resources is preferred.
...
- It also uncovers explanations for 9pp, explaining an additional 16.5% (9pp/57pp)
- Taken together, this explains between a quarter to a third of the FD before the intervention (28% = 16pp/57pp)
]
...
<div style="margin-top: -15px;">.hi-num[Our stronger intervention helps explain between a quarter to a third of the File Drawer (28%).]</div>
...
<div style="position: absolute; bottom: 20px; left: 30px; text-align: center;">
<span style="font-size: 13px; color: #ccc;">tinyurl.com/22njy3t6</span><br/>
<img src="figs/qr_slides.png" style="width: 180px; border: none; background: white; padding: 5px;"/><br/>
<span style="font-size: 14px; color: #ccc;">fhoces@berkeley.edu</span>
</div>
...
<tbody>
<tr class="panel-hdr"><td colspan="4">A:</td></tr>
...
## Registration Descriptives Across Encoders
...
<tr class="panel-hdr"><td colspan="5">Fraction of hypotheses per registration</td></tr>
...
<tr class="panel-hdr"><td colspan="7">C: Fraction of hypotheses per registration that are</td></tr>
