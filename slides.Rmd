...
# Main Finding #1: <br/> Measuring the Size of The File Drawer <br/> for RCTs in Economics
...
## File Drawer, Pre vs. Post Intervention

```{r}
knitr::include_graphics(png_path("filedrawer_post_base.pdf"))
```

.small[Same geometry as the main waterfall, but adding post-intervention recoveries.]
...
**Q2. What prevents researchers from reporting missing pre-registered results?** .hi-num[Engagement is the binding constraint (~6pp)]
...
.footnote[Thanks — `fhoces@berkeley.edu`]
